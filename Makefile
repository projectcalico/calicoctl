...
calico_node/.calico_node.created: $(NODE_CONTAINER_FILES)
	cd calico_node && docker build -t calico/node:v0.21.0 .
...
calico-node.tar: calico_node/.calico_node.created
	docker save --output calico-node.tar calico/node:v0.21.0
