...
NODE_CONTAINER_NAME?=calico/node:v1.0.0-beta-rc2
...
FELIX_CONTAINER_NAME?=calico/felix:2.0.0-beta-rc2
LIBNETWORK_PLUGIN_CONTAINER_NAME?=calico/libnetwork-plugin:v1.0.0-beta-rc1
