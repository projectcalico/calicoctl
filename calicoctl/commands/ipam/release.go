...
Options:
  -h --help                    Show this screen.
     ...
     --from-report=<REPORT>    Release all leaked addresses from the report.  If multiple reports are specified then
                               ...
                               different times, e.g. separated by an hour, or use consecutive daily reports, this can be
                               used to provide additional certainty that the IPs are truly leaked rather than in a 
                               transient state
