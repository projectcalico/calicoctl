...
- Each network should be given a unique "name"l
...
to create a transient systemd service.
 ...
 We can then use `rkt list` to show the IP address
    ...
    sudo rkt list |grep nginx
    216ccef2	nginx	registry-1.docker.io/library/nginx:latest	running	net1:ip4=192.168.0.0, default-restricted:ip4=172.16.28.21
...
[![Analytics](https://ga-beacon.appspot.com/UA-52125893-3/calico-containers/docs/cni/rkt/VagrantCoreOS.md?pixel)](https://github.com/igrigorik/ga-beacon)