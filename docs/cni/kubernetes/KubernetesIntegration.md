...
wget http://www.projectcalico.org/builds/calicoctl?circleci-branch=v0.18.0-candidate
...
ExecStartPre=/usr/bin/wget -N -P /opt/bin http://www.projectcalico.org/builds/calicoctl?circleci-branch=v0.18.0-candidate
