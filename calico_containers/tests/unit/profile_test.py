...
class TestProfile(unittest.TestCase):
    ...
    def test_profile_rule_add_remove_add_rule_exists(self, m_client):
        """
        Test for profile_rule_add_remove when adding a Rule that already exists
    ...
    def test_profile_rule_add_remove_remove_inbound(self, direction_arg,
        ...
        Test positions None and 1
        (if out of bounds positions provided, function will not remove the Rule)
        """
        with patch('calico_ctl.profile.client', autospec=True) as m_client:
            # Setup arguments to pass to method under test
            operation = 'remove'
    ...
    def test_profile_rule_add_remove_add_rule_exists(self, m_client):
        """
        Test for profile_rule_add_remove when removing a Rule that does not exists
